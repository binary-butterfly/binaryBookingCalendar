...
const GenericStepper = (props) => {
    return <span className="calendar-stepper">
...
const CalendarDateTimeStepper = (props) => {
    ...
    return <div className="calendar-stepper-container">
        <GenericStepper handlePrev={props.handlePreviousDate} handleNext={props.handleNextDate}
        ...
        <GenericStepper handlePrev={props.handlePreviousTime} handleNext={props.handleNextTime}
